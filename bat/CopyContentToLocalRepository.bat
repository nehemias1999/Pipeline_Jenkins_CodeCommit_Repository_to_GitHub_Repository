...
REM Usage: CopyContentToLocalRepository.bat "<source>" "<dest>" (paths may contain spaces; quote them)
REM Env Vars: none
REM Dependencies: robocopy (Windows)
REM Output: info to stdout; exit 0 ok (robocopy codes LEQ 7 mapped to 0), else robocopy code.
REM ===============================================
